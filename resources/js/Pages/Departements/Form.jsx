...
export default function Form({ data, setData, errors, processing, onSubmit, submitLabel, cancelHref = '/departements' }) {
    return (
        <form onSubmit={onSubmit} className="space-y-5">
            <div>
                <label htmlFor="nom" className="mb-1.5 block text-sm font-medium text-gray-700">Nom du département</label>
