...
export function Flame(props) { return <IconBase {...props}><path d="M8.5 14.5A2.5 2.5 0 0 0 11 17h2a3 3 0 0 0 3-3c0-1.5-1-2.5-2-3.5-.7-.7-1.4-1.4-1.8-2.3-.4 1.2-1.2 2.2-2 3.1-.8.9-1.7 1.8-1.7 3.2Z" /><path d="M12 2s4 4 4 8a4 4 0 0 1-8 0c0-2 1-3.5 2.4-5.1C11.3 3.8 12 2 12 2Z" /></IconBase>; }
